            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-8">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="<?= BASE_URL ?>" class="text-white breadcrumb-link"><i class="fa fa-home"></i> Trang chủ</a></li>
...
.cart-table-style th, .cart-table-style td {
    padding: 15px;
    text-align: center;
}
...
.cart-table-style td.pro-price, .cart-table-style td.pro-quantity, .cart-table-style td.pro-subtotal {
    width: 120px;
}
